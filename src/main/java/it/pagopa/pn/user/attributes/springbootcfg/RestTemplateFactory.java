...
public class RestTemplateFactory {
    ...
    public RestTemplateFactory(it.pagopa.pn.commons.pnclients.RestTemplateFactory templateFactory) {
    ...
    public RestTemplate restTemplateWithOffsetDateTimeFormatter(@Value("${pn.commons.retry.max-attempts}") int retryMaxAttempts,
