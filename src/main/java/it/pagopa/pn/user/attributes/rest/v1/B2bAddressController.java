...
import it.pagopa.pn.user.attributes.user.attributes.b2b.generated.openapi.server.v1.api.CourtesyApi;
...
@RestController
@Slf4j
public class B2bAddressController implements CourtesyApi {
    ...
    @Override
    public Mono<ResponseEntity<Flux<CourtesyDigitalAddressDto>>> getCourtesyAddressBySender(String xPagopaPnCxId, CxTypeAuthFleetDto xPagopaPnCxType, String senderId, List<String> xPagopaPnCxGroups, String xPagopaPnCxRole, final ServerWebExchange exchange) {
